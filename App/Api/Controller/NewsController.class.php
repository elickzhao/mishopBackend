...
class NewsController extends PublicController
{
    ...
    public function saveAddress()
    {
        if (IS_GET) {
            ...
            //如果没有地址设为默认地址
            if (0 == M('address')->where(['uid' => $data['uid']])->count()) {
                $data['is_default'] = 1;
